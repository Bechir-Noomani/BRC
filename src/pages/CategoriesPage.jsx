...
const CategoriesPage = () => {
  ...
  return (
    <div className="min-h-screen pt-[120px] bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div>
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-red-500 mb-10 leading-relaxed">
